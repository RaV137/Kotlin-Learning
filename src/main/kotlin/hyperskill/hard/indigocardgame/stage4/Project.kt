package hyperskill.hard.indigocardgame.stage4
...
class Player(val playerType: PlayerType = PlayerType.HUMAN) {
    var score = 0
    var cardsGathered = 0
...
class Game {
    ...
    private val players = listOf(Player(), Player(PlayerType.COMPUTER))
